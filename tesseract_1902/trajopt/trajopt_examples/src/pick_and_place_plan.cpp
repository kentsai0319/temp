...
int main(int argc, char** argv)
{
  ...
  pnh.param<int>("steps_per_phase", steps_per_phase, 15);
  //pnh.param<int>("steps_per_phase", steps_per_phase, 5);
  ...
  //-0.580894   0.989087  -0.107104    -1.1539   0.106085     1.0038   0.873769
  //-0.611426  0.836259 -0.192261  -1.47077  0.189426  0.852778  0.704162
  joint_states["iiwa_joint_1"] = -0.611426;
  joint_states["iiwa_joint_2"] = 0.836259;
  joint_states["iiwa_joint_3"] = -0.192261;
  joint_states["iiwa_joint_4"] = -1.47077;
  joint_states["iiwa_joint_5"] = 0.189426;
  joint_states["iiwa_joint_6"] = 0.852778;
  joint_states["iiwa_joint_7"] = 0.704162;
...

  {
    ...
    obj2->visual.shape_poses.push_back(box2_pose);
    obj2->collision.shapes.push_back(box2);
    obj2->collision.shape_poses.push_back(box2_pose);
    ...
    Eigen::Isometry3d object2_pose = Eigen::Isometry3d::Identity();
    //object2_pose.translation() += Eigen::Vector3d(-0.25, 0.4, 0.5);
    object2_pose.translation() += Eigen::Vector3d(0.0, 0.5, 0.4);
    attached_body2.object_name = "box2";
    attached_body2.parent_link_name = "workcell_base";
    attached_body2.transform = object2_pose;
  ...
  //Eigen::Quaterniond orientation(0.0, 0.0, 0.7071, 0.7071);
  //final_pose.linear() = orientation.matrix();
  //final_pose.translation() += Eigen::Vector3d(0.0, 0.7, 0.9);
  Eigen::Quaterniond orientation(0.0, 0.0, 1.0, 0.0);
  final_pose.linear() = orientation.matrix();
  final_pose.translation() += Eigen::Vector3d(-0.4, 0.4, 1.0);
